...
while(of2.poll() == None):
	...
	if(line != ""):
		...
		if (not smileDetected) and (smileValR > baselineDist * 1.5) and (smileValL>baselineDist * 1.5) and (eyebrowHeight<baselineDist * 2.5)  and (midSurprise<baselineDist*1.2):
		...
		if (not shockDetected) and ((eyebrowBottL[1] - eyebrowL[1]) > baselineDist * 2.5) and (midSurprise>baselineDist*2) and (pitch>-.35):
			print("SHOCKED")
			shockDetected=True
